    ...
    */
    ...
    if (args.length > 1) {
      ...
      */
    	...
    	//Hard code in text. 
    	//CLASSIFYtoString is method to analyze text !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      String[] example = {"Fox River Grove", "Cary", "Minsk", "Chicago"," Timbuktu"," Normandy"," Paris"," Warsaw","Europe","U.S."," London Bern Churchill Lexington Pittsburgh "};
